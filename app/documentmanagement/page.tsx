...
const DocumentManagement = () => {
	...
	return (
		<div>
			<PageHeader text={"Document Management"} textsup={''} />

			<div className='flex flex-col md:flex-row justify-between gap-[20px] mt-[24px]'>
				<Search />
				<button className="flex flex-row justify-center items-center  py-[8px] gap-2  px-[20px] !bg-[#002DB3]  font-normal text-[14px] leading-[150%] text-[#FFFFFF]">
					Upload
				</button>
			</div>
